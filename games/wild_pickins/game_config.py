# E02 scaffold: inherited paytable, caps, modes and probabilities are template-only.
...
class GameConfig(Config):
    ...
    def __init__(self):
        super().__init__()
        self.game_id = "wild_pickins"
        self.provider_number = 0
        self.working_name = "Wild Pickins — Template Scaffold"
        self.wincap = 5000.0
        self.win_type = "lines"
        self.rtp = 0.9670
